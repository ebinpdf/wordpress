...
function mbt_save_seo_metabox($post_id)
{
	...
	{
		if(isset($_REQUEST['mbt_seo_title'])) { update_post_meta($post_id, "mbt_seo_title", sanitize_text_field($_REQUEST['mbt_seo_title'])); }
		if(isset($_REQUEST['mbt_seo_metadesc'])) { update_post_meta($post_id, "mbt_seo_metadesc", sanitize_text_field($_REQUEST['mbt_seo_metadesc'])); }
	}
}
